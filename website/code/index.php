...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content menuMovil">
                <ul class="menuPrin">
                    ...
                    <li class="menuPrin__item"><a href="#">Capacitacion</a></li>
    ...
    <main>
                ...
                <div class="row justify-content-around" id="filaIni">
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4 carousel-item active" id="ele1">
                        <div class="card my-cards">
                            <img class="card-img-top img-fluid imgc" src="assest/images/html.png" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Tema de Robos a Casas 1 - Como prevenir robos</h5>
                                <p class="card-text">
                            ...
                            <div class="card-footer">
                                <div class="row justify-content-around align-items-center">
                                    <div class="col-auto">
                                        <img class="img-fluid rounded-circle" src="assest/images/avatar.jpg" alt="Card image cap"
                                            height="50px" width="50px">
                                    </div>
                                    <div class="col-auto mr-auto colort">
                                        <span>Ramiro Castillo</span>
                                    </div>
                                    <div class="col-auto">
                                        <button type="button" name="button" class="btn-cap">CAPACITATE</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4 carousel-item " id="ele2">
                        <div class="card my-cards">
                            <img class="card-img-top img-fluid imgc" src="assest/images/html.png" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Tema de Robos a Casas 2 - Como prevenir robos</h5>
                                <p class="card-text">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.
                                </p>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4 carousel-item" id="ele3">
                        <div class="card my-cards">
                            <img class="card-img-top img-fluid imgc" src="assest/images/html.png" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Tema de Robos a Casas 3 - Como prevenir robos</h5>
                                <p class="card-text">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.
                                </p>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4 carousel-item" id="ele4">
                        <div class="card my-cards ">
                            <img class="card-img-top img-fluid imgc" src="assest/images/html.png" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Tema de Robos a Casas 4 - Como prevenir robos</h5>
                                <p class="card-text">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.
                                </p>
                    ...
                    <div class="col-12  col-md-6 col-lg-4 col-xl-4 carousel-item" id="ele5">
                        <div class="card my-cards">
                            <img class="card-img-top img-fluid imgc" src="assest/images/html.png" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Tema de Robos a Casas 5 - Como prevenir robos</h5>
                                <p class="card-text">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.
                                </p>
                    ...
                    <div class="col-12  col-md-6 col-lg-4 col-xl-4 carousel-item" id="ele5">
                        <div class="card my-cards">
                            <img class="card-img-top img-fluid imgc" src="assest/images/html.png" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Tema de Robos a Casas 6 - Como prevenir robos</h5>
                                <p class="card-text">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.
                                </p>
        ...
        <section class="carousel slide fondogris d-none d-md-block d-lg-none" data-ride="carousel" id="card-slide2">
            <div class="container carousel-inner">
                <div class="row justify-content-around carousel-item active">
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4 " id="ele1">
                        <div class="card my-cards">
                            <img class="card-img-top img-fluid imgc" src="assest/images/html.png" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Tema de Robos a Casas 1 - Como prevenir robos</h5>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4" id="ele2">
                        <div class="card my-cards">
                            <img class="card-img-top img-fluid imgc" src="assest/images/html.png" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Tema de Robos a Casas 2 - Como prevenir robos</h5>
                ...
                <div class="row justify-content-around ml-1 carousel-item">
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4 " id="ele3">
                        <div class="card my-cards">
                            <img class="card-img-top img-fluid imgc" src="assest/images/html.png" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Tema de Robos a Casas 3 - Como prevenir robos</h5>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4" id="ele4">
                        <div class="card my-cards ">
                            <img class="card-img-top img-fluid imgc" src="assest/images/html.png" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Tema de Robos a Casas 4 - Como prevenir robos</h5>
                ...
                <div class="row justify-content-around ml-1 carousel-item">
                    <div class="col-12  col-md-6 col-lg-4 col-xl-4" id="ele5">
                        <div class="card my-cards">
                            <img class="card-img-top img-fluid imgc" src="assest/images/html.png" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Tema de Robos a Casas 5 - Como prevenir robos</h5>
                                        ...
                                        <div class="testimonio__detalle">
                                            <div class="row justify-content-between">
                                                <div class="col-md-2 col-lg-2 col-xl-2 col-sm-12 col-12 ">
                                                    <figure class="testimonio__img icon-bubble-quote">
